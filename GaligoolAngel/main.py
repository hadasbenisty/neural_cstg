...
cc_dynamic_analysis = cc[results_processor.dynamic_neurons, results_processor.dynamic_neurons, :]
...
cc_important_analysis = cc[results_processor.important_neurons, results_processor.important_neurons, :]
