...
save(fullfile(inputs_path, 'dataset_fake.mat'), 'y', ...
...
fig_x_example = figure;
scatter(features(1, [1:500, end-500:end]), features(2, [1:500, end-500:end]), 10, ...
    context([1:500, end-500:end]), "filled");
colormap('jet');
title("X as a function of context")
xlabel('feature 1');
ylabel("feature 2");
