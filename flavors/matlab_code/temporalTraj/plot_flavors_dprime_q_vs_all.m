function plot_flavors_dprime_q_vs_all(datapath, resultspath, animals_names, figspath)
...
type2 = {'random','batch'};
dprime_animals = nan(1000, 2, length(type1), ...
...
for animal_i = 1:length(animals_names)
    ...
    dprimeall = nan(1000, 2, length(datesList));
